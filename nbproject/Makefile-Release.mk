...
${OBJECTDIR}/src/creationals/factory/AbstractCoffee.o: src/creationals/factory/AbstractCoffee.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/creationals/factory/AbstractCoffee.o src/creationals/factory/AbstractCoffee.cpp

${OBJECTDIR}/src/creationals/factory/CoffeeMachine.o: src/creationals/factory/CoffeeMachine.cpp
	${MKDIR} -p ${OBJECTDIR}/src/creationals/factory
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/creationals/factory/CoffeeMachine.o src/creationals/factory/CoffeeMachine.cpp

${OBJECTDIR}/src/creationals/factory/SugarLessCoffee.o: src/creationals/factory/SugarLessCoffee.cpp
	${MKDIR} -p ${OBJECTDIR}/src/creationals/factory
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/creationals/factory/SugarLessCoffee.o src/creationals/factory/SugarLessCoffee.cpp

${OBJECTDIR}/src/creationals/factory/SweetCoffee.o: src/creationals/factory/SweetCoffee.cpp
	${MKDIR} -p ${OBJECTDIR}/src/creationals/factory
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/creationals/factory/SweetCoffee.o src/creationals/factory/SweetCoffee.cpp

${OBJECTDIR}/src/creationals/factory/merda.o: src/creationals/factory/merda.cpp
	${MKDIR} -p ${OBJECTDIR}/src/creationals/factory
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/creationals/factory/merda.o src/creationals/factory/merda.cpp
...
${OBJECTDIR}/src/creationals/singleton/SingletonSun.o: src/creationals/singleton/SingletonSun.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/creationals/singleton/SingletonSun.o src/creationals/singleton/SingletonSun.cpp
